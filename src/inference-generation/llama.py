"""
inference_llama_short.py
Minimal LLaMA inference for:
- Web code generation
...
class InferenceConfig:
    def __init__(self, config_path=INFERENCE_CONFIG_PATH, model_type="llama"):
...
class LlamaGenerator:
    ...
    def generate(
        ...
        """
        Auto-continuing generation to avoid truncation.
        Returns:
            text, total_tokens
        """
...
class ContentGenerator:
    def __init__(self, generator: LlamaGenerator):
        self.gen = generator
...
if __name__ == "__main__":
    ...
    #     "Landing page using HTML/CSS with a hero section and CTA button"
    # )
